...
N_1_TT <- TT(I_94_WB_TT_melt,228.51,'15 mins')
...
write.csv(N_1_final,'N_1_final_rev1.csv',na='Null',row.names = FALSE)
```
...
write.csv(S_4_final,'S_4_final_rev1.csv',na='Null',row.names = FALSE)
```
