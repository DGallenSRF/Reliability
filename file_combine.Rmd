...
N_1_merge$crash2 <- sapply(N_1_merge$cut_floor.x, function(x) any(x < N_1_MNCMAT$EndDateTime & x > N_1_MNCMAT$DateTime))
...
N_1_merge$IRIS1 <- sapply(N_1_merge$DateTime, function(x) any(x < N_1_IRIS$Max_DateTime & x > N_1_IRIS$Min_DateTime))
N_1_merge$IRIS2 <- sapply(N_1_merge$cut_floor.x, function(x) any(x < N_1_IRIS$Max_DateTime & x > N_1_IRIS$Min_DateTime))
N_1_merge$IRIS <- ifelse(N_1_merge$IRIS1==TRUE | N_1_merge$IRIS2==TRUE,TRUE,FALSE) 
  
```

```{r final_crash}
N_1_merge$Crash <- if_else(N_1_merge$IRIS==TRUE|N_1_merge$MNCMAT==TRUE,1,0)
```
...
N_1_merge$weather2 <- sapply(N_1_merge$cut_floor.x, function(x) any(x < weather_MSP$End_Time & 
                                                                      x > weather_MSP$Starting_Time))
N_1_merge$weather <- ifelse(N_1_merge$weather2==TRUE | N_1_merge$weather1==TRUE,1,0) 
```

```{r N_1_final}
N_1_final <- N_1_merge %>% select(DateTime,VMT_total,TT_mean,weather,Crash)
...
```{r final_crash}
S_3_merge$Crash <- if_else(S_3_merge$IRIS==TRUE|S_3_merge$MNCMAT==TRUE,1,0)
```
...
```{r S_3_final}
S_3_final <- S_3_merge %>% select(DateTime,VMT_total,TT_mean,weather,Crash)
...
### N_2 I-94_WestBound MP 228.52 - MP 225.63
...
N_2_merge$crash2 <- sapply(N_2_merge$cut_floor.x, function(x) any(x < N_2_MNCMAT$EndDateTime & x > N_2_MNCMAT$DateTime))
...
N_2_merge$IRIS1 <- sapply(N_2_merge$DateTime, function(x) any(x < N_2_IRIS$Max_DateTime & x > N_2_IRIS$Min_DateTime))
N_2_merge$IRIS2 <- sapply(N_2_merge$cut_floor.x, function(x) any(x < N_2_IRIS$Max_DateTime & x > N_2_IRIS$Min_DateTime))
N_2_merge$IRIS <- ifelse(N_2_merge$IRIS1==TRUE | N_2_merge$IRIS2==TRUE,TRUE,FALSE) 
  
```

```{r final_crash}
N_2_merge$Crash <- if_else(N_2_merge$IRIS==TRUE|N_2_merge$MNCMAT==TRUE,1,0)
```
...
N_2_merge$weather1 <- sapply(N_2_merge$DateTime, function(x) any(x < weather_MSP$End_Time &
                                                                   x > weather_MSP$Starting_Time))
N_2_merge$weather2 <- sapply(N_2_merge$cut_floor.x, function(x) any(x < weather_MSP$End_Time & 
                                                                      x > weather_MSP$Starting_Time))
N_2_merge$weather <- ifelse(N_2_merge$weather2==TRUE | N_2_merge$weather1==TRUE,1,0) 
```

```{r N_2_final}
N_2_final <- N_2_merge %>% select(DateTime,VMT_total,TT_mean,weather,Crash)
